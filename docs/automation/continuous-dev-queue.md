...
- [ ] **P1. Player Secrets — sealed reveals & character keys (player site).** *(Phase 1 ✅ 2026-06-20 `174a4f23`; Phase 2 ✅ 2026-06-20 `e0f8380e` — next: Phase 3 character secrets tab)*

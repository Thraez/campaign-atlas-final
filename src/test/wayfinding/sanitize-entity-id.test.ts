...
it("keeps data-entity-id on a wikilink anchor", () => {
  const out = sanitizeAtlasHtml(
    '<a class="atlas-wikilink" data-entity-id="saltmere" href="#/entity/saltmere">Saltmere</a>',
  );
...
it("keeps aria-haspopup on a wikilink anchor", () => {
  const out = sanitizeAtlasHtml(
    '<a class="atlas-wikilink" data-entity-id="saltmere" href="#/entity/saltmere" aria-haspopup="dialog">Saltmere</a>',
  );

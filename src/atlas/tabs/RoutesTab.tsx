          ...
          {!drawing ? (
            ...
            <>
              ...
              <Button
                ...
                onClick={() => {
                  const id = finishDraw();
                  if (!id) toast.warning("Need at least 2 waypoints.");
                }}
        ...
        {drawing && (
          <div className="space-y-2 rounded-md border border-border bg-card/50 p-2">
            <div className="flex items-center gap-1.5">
              ...
              <Select
                value={waypointMode}
                onValueChange={(v) => setWaypointMode(v as WaypointMode)}
              >
                <SelectTrigger className="h-6 text-[10px] w-24">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="coord" className="text-xs">
                    coord
                  </SelectItem>
            ...
            <p className="text-[10px] text-muted-foreground italic">
              {waypointMode === "entity"
                ? "Pick an entity to add as a waypoint."
                : "Click on the map to add a coord waypoint."}
              ...
              <div className="flex gap-1">
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    if (!project.entities.some((e) => e.id === entityToAdd)) {
                      toast.error("Unknown entity id.");
                      return;
                    }
            ...
            return (
              ...
              >
                <span
                  ...
                  style={{ background: r.color ?? "#cfd6dc" }}
                />
          ...
          <div className="rounded-md border border-border p-2.5 space-y-2.5 bg-card/50">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-0.5">
                <Button
                  ...
                  onClick={() => onFitTo?.(resolveRoute(selected))}
                >
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <div>
                ...
                <Select
                  value={selected.mode ?? "foot"}
                  onValueChange={(v) => patch(selected.id, { mode: v as RouteMode })}
                >
                  <SelectTrigger className="h-7 text-xs">
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div>
                ...
                <Slider
                  ...
                  max={10}
                  step={1}
                  value={[selected.weight ?? 3]}
                  onValueChange={([v]) => patch(selected.id, { weight: v })}
                />
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(v) => patch(selected.id, { dashed: v })}
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => patch(selected.id, { description: e.target.value || undefined })}
                className="h-7 text-xs"
              />
            </div>
...
function WaypointList({
  ...
  route: Route;
  onSwap: (idx: number, entityId: string) => void;

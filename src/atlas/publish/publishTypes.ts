 ...
 * Canonical home is src/ so the client UI can import them.
 * scripts/atlas/publishTypes.ts re-exports from here.
 *
...
export interface PublishScanReason {
  ...
  target: string;
  severity: "blocking";
  /** Plain-language message; from the static template — NEVER scan output. */
  message: string;
